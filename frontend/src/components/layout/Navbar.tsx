...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white/70 backdrop-blur-xl border-b border-gray-100/50 h-20 transition-all duration-300 w-full">
      <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
        <Link to="/" className="text-3xl font-display font-bold text-primary tracking-tight hover:text-primary-hover transition-colors">
          Phevon
        </Link>
        ...
        <div className="flex items-center gap-6">
          ...
          <Link to="/cars" className="text-gray-600 hover:text-primary transition-colors font-medium">
            Browse Cars
          </Link>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2 pl-4 border-l border-gray-200">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 text-gray-500 hover:text-red-500 transition-colors ml-4 font-medium"
                >
                    <LogOut size={16} />
                    <span>Logout</span>
                </button>
